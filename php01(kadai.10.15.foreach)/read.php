...
$array = array('number'=>$number,'name'=>$name,'birth'=>$birth,'sex'=>$sex,'nation'=>$nation,'address'=>$address,'status'=>$status,'work'=>$work,'limit'=>$limit);
// var_dump($array);
foreach ($array as $key => $value){
    echo '<tbody id=sortdata>';
    echo '<tr>';
    echo '<td>'.$str[0].'</td>';
    echo '<td>'.$str[1].'</td>';
    echo '<td>'.$str[2].'</td>';
